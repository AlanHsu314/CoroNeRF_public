    ...
    for t in range(nrad):
            ...
            for ku in range(0,int(2*Ju)+1,see_dk):
                for kr in range(3):
                    ...
                    if (val != 0):
                        ...
                        taD_indx[0, tacnt] = idx_src
                        taD_indx[1, tacnt] = idx_dst
                        taD_indx[2, tacnt] = kr
                        taD_indx[3, tacnt] = t
            ...
            for kpr in range(0,int(2*Jl)+1,see_dk):
                for kr in range(3):
                    ...
                    if (val != 0):
                        ...
                        raD_indx[0, racnt] = idx_src
                        raD_indx[1, racnt] = idx_dst
                        raD_indx[2, racnt] = kr
                        raD_indx[3, racnt] = t
            ...
            for ku in range(0,int(2*Ju)+1,see_dk):
                for kr in range(3):
                    ...
                    if (val != 0):
                        ...
                        tsD_indx[0, tscnt] = idx_src
                        tsD_indx[1, tscnt] = idx_dst
                        tsD_indx[2, tscnt] = kr
                        tsD_indx[3, tscnt] = t
            ...
            for kpr in range(0,int(2*Ju)+1,see_dk):
                for kr in range(3):
                    ...
                    if (val != 0):
                        ...
                        rsD_indx[0, rscnt] = idx_src
                        rsD_indx[1, rscnt] = idx_dst
                        rsD_indx[2, rscnt] = kr
                        rsD_indx[3, rscnt] = t
            ...
            for ku in range(0,int(2*Ju)+1,see_dk):
                if (kl == ku):
                    ...
                    if (val != 0):
                        ...
                        teD_indx[0, tecnt] = idx_src
                        teD_indx[1, tecnt] = idx_dst
                        teD_indx[2, tecnt] = t
        ...
        for ku in range(0,int(2*Ju)+1,see_dk):
            ...
            if (val != 0):
                ...
                reD_indx[0, recnt] = idx_src
                reD_indx[1, recnt] = idx_dst
                reD_indx[2, recnt] = t
